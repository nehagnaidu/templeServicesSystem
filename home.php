...
<body>
    ...
    <div class="scroll-header">
        <h3>Update Scroll</h3>
        <p>get latest updates here</p>
    </div>
    <div class="scroll-content">
        <div class="schedule-item">
            <strong>Darshan Bookings for the month of September has started.To book <a href="darshanbooking.php">Click here</a>. </strong>
        </div>
        <div class="schedule-item">
            <strong>Accommodation Bookings for the month of September has started.To book <a href="accomodation.php">Click here</a>. </strong>
        </div>
        <div class="schedule-item">
            <strong>Darshan Bookings for October will start from 20/09/2024 at 10:00 am. </strong>
        </div>
        <div class="schedule-item">
            <strong>To book Sevas <a href="sevabooking.php">Click here</a>.</strong>
        </div>
        <div class="schedule-item">
            <strong>Accommodation Bookings for October will start from 21/09/2024 at 10:00 am. </strong>
        </div>
    </div>
</div>
